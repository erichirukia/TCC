    ...
    <body>
        ...
        <div class="container">
            <div class="centro col-lg-12">
                ...
                <div class="caracteristica col-lg-4 col-sm-10">
                    <div class="icone col-lg-12">
                        <br><br>
                        <center><span class="fa fa-user-circle-o fa-5x"></span></center>
                        <br>
                    </div>
                    <div class="col-lg-12">
                    <br>
                    <span class="fa fa-user-circle-o"></span> <?php echo " ".$_SESSION['nome']." ".$_SESSION['sobrenome'];?><br>
                    <span class="fa fa-envelope"></span> <?php echo " ".$_SESSION['email'];?><br>
                    <span class="fa fa-address-card-o "></span> <?php echo " ".$_SESSION['cpf'];?><br>
                    <span class="fa fa-phone "></span> <?php echo " ".$_SESSION['fone'];?><br>
                    <span class="fa fa-user-o"></span> <?php echo " ".$_SESSION['nivel'];?>
                    </div>
                    <div class="col-lg-12">
